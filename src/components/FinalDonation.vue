                ...
                <div class="form-group my-lg-5 my-md-0">
                  <label class="form-group has-float-label">
                    <input
                      ...
                      ref="cpfInput"
                    />
                    <span for="cpf" class="white">Número do cartão</span>
                  </label>
                </div>
                <div class="form-group mb-5 mb-md-0">
                  <label class="form-group has-float-label">
                    <input
                      ...
                      ref="nameInput"
                    />
                    <span for="name" class="white">Nome impresso no cartão</span>
                  </label>
                </div>
                <div class="form-group my-5 my-md-0">
                  <label class="form-group has-float-label">
                    <input
                      ...
                      ref="phoneInput"
                    />
                    <span for="phone" class="white">Validade</span>
                  </label>
                </div>
                <div class="form-group my-5 my-md-0">
                  <label class="form-group has-float-label">
                    <input
                      ...
                      ref="cvvInput"
                    />
                    <span for="cvv" class="white">CVV</span>
                  </label>
                </div>
